...
export const LessonSegmentCard: FC<Props> = (props) => {
    ...
    return <Card isFooterBlurred className="h-[300px]">
        ...
        <CardFooter className="absolute z-10 bottom-0 flex-col !items-start px-6 before:bg-black/100 shadow-small ml-1">
